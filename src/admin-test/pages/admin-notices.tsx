          ...
          <>
            ...
            <div className="flex-1 overflow-y-auto px-6 py-5">
              ...
              <div className="mb-4 grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    value={editTarget}
                    onChange={(e) =>
                      setEditTarget(e.target.value as NoticeTarget)
                    }
                  >
                    <option value="MAIN">메인 (고객)</option>
                ...
                <div>
                  ...
                  <select
                    ...
                    value={editStatus}
                    onChange={(e) =>
                      setEditStatus(e.target.value as NoticeStatus)
                    }
                  >
              ...
              <div className="mb-4">
                ...
                />
                <p className="h-6 text-right text-sm text-gray-400">
                  {isFormActive && `${editContent.length}자`}
                </p>
              </div>
