        ...
        children: [
          {
            ...
            children: [
              ...
              { path: ROUTES.ADMIN_MAP, element: <AdminMap /> },
              { path: ROUTES.ADMIN_POSTS, element: <AdminPosts /> },
              { path: ROUTES.ADMIN_STORIES, element: <AdminStories /> },
              { path: ROUTES.ADMIN_CLASSES, element: <AdminClasses /> },
              { path: ROUTES.ADMIN_ARTISTS, element: <AdminArtists /> },
              { path: ROUTES.ADMIN_NOTICES, element: <AdminNotices /> },
              {
                path: ROUTES.ADMIN_SETTINGS_MAIN,
                element: <AdminMainSettings />,
              },
              {
                path: ROUTES.ADMIN_SETTINGS_DESIGN,
